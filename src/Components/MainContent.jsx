  ...
  return (
    <main className="">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className=" w-[320px] h-[360px] rounded-t-[20px] pt-[48px] pr-[32px] pb-[64px] pl-[32px] bg-[#8EA7FF] ">
        ...
        <div className=" w-[320px] h-[360px] rounded-b-[20px]  pt-[48px] pr-[32px] pb-[64px] pl-[32px] bg-[#B496F3] ">
